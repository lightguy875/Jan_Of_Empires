...
const unsigned short MP_INICIAL_GUERREIRO = 30;
const unsigned short MP_INICIAL_ARQUEIRO = 30;
const unsigned short MP_INICIAL_CAVALEIRO = 30;

const unsigned short HP_INICIAL_PILAR_ESPADA = 100;
const unsigned short HP_INICIAL_PILAR_ARCO = 100;
const unsigned short HP_INICIAL_PILAR_LANCA = 100;
