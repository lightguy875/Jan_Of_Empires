...
Dividimos o grupo em dois times: FRONTEND e BACKEND.

>>> FRONTEND
Alexander André (Alexander-1995@github.com)
Matheus Veleci (matheusvsantos@github.com)
Luis Luz (lightguy875@github.com)
>>> BACKEND
Alex Siqueira (siqueiralex@github.com)
Arthur Veiga (arthurveiga@github.com)

As tarefas de backend e frontend foram definidas em sprints de duas semanas.

----- COMPILAÇÃO: PRÉREQUISITOS -----
